...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER(__name__).info(f"جلب معلومات 🧚‍♀️...")
        if config.STRING1:
            await self.one.start()
            try:
                await self.one.join_chat("K55DD")
                await self.one.join_chat("fzfffzz")
                await self.one.join_chat("soper_kings")
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(config.LOGGER_ID, "♡ تم تشغيل البوت على سورس وايت ♡")
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("soper_kings")
                await self.two.join_chat("fzfffzz")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("fzfffzz")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("soper_kings")
                await self.four.join_chat("fzfffzz")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("soper_kings")
                await self.five.join_chat("fzfffzz")
            except:
                pass
            assistants.append(5)
            try:
